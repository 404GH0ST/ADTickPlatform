...
var (
	...
	ErrNotTeamCaptain         = errors.New("team captain privileges required")
	ErrInvalidCaptainTransfer = errors.New("invalid captain transfer")
)
...
type Store interface {
	...
	TransferTeamCaptain(ctx context.Context, captainPlayerID, targetPlayerID int) (authenticatedPlayer, error)
